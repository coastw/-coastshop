        ...
        <script type="text/javascript">
            $(function() {
                        ...
                        if (validate(sno)) {
                            ...
                            $.post("ajax.do", {method: "getprice", keyword: $("#sno").val()}, function(data) {
                                ...
                                if (price === 0) {
                                    ...
                                    if (sno.length === 16) {
                                        $("#sn").val(sno.substring(0, 11));
                                        $("#snlable").text(sno.substring(0, 11));
                                    }
                                    if (sno.length === 18) {
                                        $("#sn").val(sno.substring(0, 13));
                                        $("#snlable").text(sno.substring(0, 13));
                                    }
                ...
                function validate(sno) {
                    ...
                    //区分15年前后
                    var regex = "";
                    if (sno.substring(0, 2) === "15") {
                        regex = /<%= ProductUtil.SNOREGEX2015%>/;
                    } else {
                        regex = /<%= ProductUtil.SNOREGEX%>/;
                    }
