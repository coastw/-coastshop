/*
 * 2015款款号分析工具类
 * Last Eidted Date:2015.08.21 13.19
 */
...
public class ProductUtil2015 {
    ...
    //15103AF020104
    //15102AE020007
    public static final String NEWREG = "^[1]{1}[5-9]{1}[1-8]{1}[0-9]{2}[A-Z]{2}[0-9]{6}$";     //edited 2015.08.21 13.22
    public static final String SNREGEX = "^[1]{1}[5-9]{1}[1-8]{1}[0-9]{2}[A-Z]{2}[0-9]{6}$";
    public static final String COLORREGEX = "^[0-9]{3}$";
    public static final String SIZEREGEX = "^[0][1-5]$";
    public static final String SNOREGEX = "[1]{1}[5-9]{1}[1-8]{1}[0-9]{2}[A-Z]{2}[0-9]{6}[0-9]{3}[0][1-5]$";        //edited 2015.08.21 13.43
...
//    public static final String SNOREGEX = "^[1]{1}[0-9]{1}[1-8]{1}[0-9a-zA-Z]{0,2}[0-9]{6,7}[0-9]{3}[0][1-5]$";
    ...
    public static String getType(String sn) {
        ...
        if (sn.matches(NEWREG)) {// after 2014
...
//                thirdType = "礼服裙";
    ...
    public static boolean checkSNO(String sno) {
        ...
        String color = null;
        String size = null;
        //1 5 1 0 1 A E 0 2 0 0 1 2    0 2 0    0 2
