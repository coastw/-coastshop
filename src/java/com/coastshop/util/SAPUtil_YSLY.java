        ...
        while (iter.hasNext()) {
            ...
            if (info != null) {
                if (!(info.getColorType().equals("#") || info.getFirstType().equals("#") || info.getFitSeason().equals("#") || info.getSecondType().equals("#") || info.getThirdType().equals("#") || info.getWorldSize().equals("#"))) {
                    ...
                    cell.setCellValue(info.getColor());
                    ...
                    cell.setCellValue(info.getYear());
                    cell = currentRow.getCell(16);  //attribute
                    cell.setCellValue("无");
                    cell = currentRow.getCell(19);  //amount
                    cell.setCellValue(Integer.toString(info.getAmount()));
